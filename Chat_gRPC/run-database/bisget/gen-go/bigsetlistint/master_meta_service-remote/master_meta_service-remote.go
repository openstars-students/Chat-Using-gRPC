...
func main() {
  ...
  client := bigsetlistint.NewMasterMetaServiceClientFactory(trans, protocolFactory)
  ...
  case "getMetaID":
    ...
    value0 := bigsetlistint.TKey(argvalue0)
    fmt.Print(client.GetMetaID(value0))
    fmt.Print("\n")
    break
  case "setMetaID":
    if flag.NArg() - 1 != 2 {
    ...
    value1 := bigsetlistint.TMetaKey(argvalue1)
    fmt.Print(client.SetMetaID(value0, value1))
    fmt.Print("\n")
    break
  case "":
    Usage()
