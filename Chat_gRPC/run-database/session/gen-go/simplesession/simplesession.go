...
type TSimpleSessionService interface {
  // Parameters:
  //  - SessionKey
  GetSession(sessionKey TSessionKey) (r *TUserResult_, err error)
}
...
func NewTSimpleSessionServiceClientFactory(t thrift.TTransport, f thrift.TProtocolFactory) *TSimpleSessionServiceClient {
  return &TSimpleSessionServiceClient{Transport: t,
    ProtocolFactory: f,
...
// Parameters:
//  - SessionKey
func (p *TSimpleSessionServiceClient) GetSession(sessionKey TSessionKey) (r *TUserResult_, err error) {
  if err = p.sendGetSession(sessionKey); err != nil { return }
  return p.recvGetSession()
}

func (p *TSimpleSessionServiceClient) sendGetSession(sessionKey TSessionKey)(err error) {
...
func (p *TSimpleSessionServiceClient) recvGetSession() (value *TUserResult_, err error) {
  ...
  if method != "getSession" {
    err = thrift.NewTApplicationException(thrift.WRONG_METHOD_NAME, "getSession failed: wrong method name")
    return
  }
  if p.SeqId != seqId {
  ...
  if mTypeId != thrift.REPLY {
    err = thrift.NewTApplicationException(thrift.INVALID_MESSAGE_TYPE_EXCEPTION, "getSession failed: invalid message type")
    return
  }
...
func (p *TSimpleSessionServiceProcessor) Process(iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
...
func (p *tSimpleSessionServiceProcessorGetSession) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  args := TSimpleSessionServiceGetSessionArgs{}
...
var retval *TUserResult_
  var err2 error
  if retval, err2 = p.handler.GetSession(args.SessionKey); err2 != nil {
...
TSimpleSessionService
  ...
  // Parameters:
  //  - UserInfo
  CreateSession(userInfo *TUserSessionInfo) (r *TSessionKeyResult_, err error)
}
...
// Parameters:
//  - UserInfo
func (p *TSimpleSessionService_WClient) CreateSession(userInfo *TUserSessionInfo) (r *TSessionKeyResult_, err error) {
  if err = p.sendCreateSession(userInfo); err != nil { return }
  return p.recvCreateSession()
}

func (p *TSimpleSessionService_WClient) sendCreateSession(userInfo *TUserSessionInfo)(err error) {
  oprot := p.OutputProtocol
  if oprot == nil {
    oprot = p.ProtocolFactory.GetProtocol(p.Transport)
    p.OutputProtocol = oprot
...
func (p *TSimpleSessionService_WClient) recvCreateSession() (value *TSessionKeyResult_, err error) {
  iprot := p.InputProtocol
  if iprot == nil {
    iprot = p.ProtocolFactory.GetProtocol(p.Transport)
    p.InputProtocol = iprot
  ...
  if method != "createSession" {
    err = thrift.NewTApplicationException(thrift.WRONG_METHOD_NAME, "createSession failed: wrong method name")
    return
  }
  if p.SeqId != seqId {
  ...
  if mTypeId != thrift.REPLY {
    err = thrift.NewTApplicationException(thrift.INVALID_MESSAGE_TYPE_EXCEPTION, "createSession failed: invalid message type")
    return
  }
...
func (p *tSimpleSessionService_WProcessorCreateSession) Process(seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  args := TSimpleSessionService_WCreateSessionArgs{}
  if err = args.Read(iprot); err != nil {
    iprot.ReadMessageEnd()
    x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
...
var retval *TSessionKeyResult_
  var err2 error
  if retval, err2 = p.handler.CreateSession(args.UserInfo); err2 != nil {
