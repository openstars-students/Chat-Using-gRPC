...
namespace java openstars.core.bigset.Generic
namespace go generic
...
service TBSGenericDataService{
    ...
    TItemSetResult bsgGetSlice(1:TContainerKey rootID, 2: i32 fromIndex, 3: i32 count)

    TItemSetResult bsgGetSliceFromItem(1:TContainerKey rootID, 2: TItemKey fromKey, 3: i32 count)

    TItemSetResult bsgGetSliceR(1:TContainerKey rootID, 2: i32 fromIndex, 3: i32 count)
    ...
    TMultiPutItemResult bsgMultiPut(1: TContainerKey rootID, 2: TItemSet setData, 3: bool getAddedItems=false, 4: bool getReplacedItems = false),
...
service TStringBigSetKVService{
    ...
    TItemSetResult bsGetSlice(1:TStringKey bsName, 2: i32 fromIndex, 3: i32 count)

    TItemSetResult bsGetSliceFromItem(1:TStringKey bsName, 2: TItemKey fromKey, 3: i32 count)

    TItemSetResult bsGetSliceR(1:TStringKey bsName, 2: i32 fromIndex, 3: i32 count)
    ...
    TMultiPutItemResult bsMultiPut(1: TStringKey bsName, 2: TItemSet setData, 3: bool getAddedItems=false, 4: bool getReplacedItems = false),
...
service TIBSDataService{
    ...
    TItemSetResult getSlice(1:TKey bigsetID, 2: i32 fromIndex, 3: i32 count)

    TItemSetResult getSliceFromItem(1:TKey bigsetID, 2: TItemKey fromKey, 3: i32 count)

    TItemSetResult getSliceR(1:TKey bigsetID, 2: i32 fromIndex, 3: i32 count)
    ...
    TMultiPutItemResult multiPut(1: TKey bigsetID, 2: TItemSet setData, 3: bool getAddedItems=false, 4: bool getReplacedItems = false),
