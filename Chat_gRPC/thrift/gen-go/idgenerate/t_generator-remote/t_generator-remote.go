...
func main() {
  ...
  client := idgenerate.NewTGeneratorClientFactory(trans, protocolFactory)
  ...
  case "createGenerator":
    ...
    value0 := argvalue0
    fmt.Print(client.CreateGenerator(value0))
    fmt.Print("\n")
    break
  case "removeGenerator":
    ...
    argvalue0 := flag.Arg(1)
    value0 := argvalue0
    fmt.Print(client.RemoveGenerator(value0))
    fmt.Print("\n")
    break
  case "getCurrentValue":
    ...
    argvalue0 := flag.Arg(1)
    value0 := argvalue0
    fmt.Print(client.GetCurrentValue(value0))
    fmt.Print("\n")
    break
  case "getValue":
    if flag.NArg() - 1 != 1 {
  ...
  case "getStepValue":
    ...
    value1 := argvalue1
    fmt.Print(client.GetStepValue(value0, value1))
    fmt.Print("\n")
    break
  case "":
    Usage()
